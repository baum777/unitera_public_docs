...
* [UNITERA Public Docs](README.md)

## Start

* [UNITERA in 5 Minuten](getting-started/unitera-in-5-minutes.md)
* [Systemkarte](architecture/system-map.md)
...
* [Personal Realm und Companion](product/personal-realm-companion.md)

## System

* [Systemüberblick](architecture/system-overview.md)
* [Architektur und Logik](architecture/architecture-and-logic-deep-dive.md)
...
* [Öffentlicher Contract-Index](contracts/README.md)

## Governance

* [Governance](reference/governance.md)
* [Public Source Assurance](reference/source-basis.md)
* [Review und Assurance](reference/reviewer-assurance-publication-status.md)
* [Public-Disclosure-Policy](reference/public-disclosure-policy.md)

## Build / Integrate

* [Build- und Integrations-Einstieg](build/README.md)
* [Mitwirken](reference/contributing.md)

## Referenz

* [Glossar](reference/glossary.md)
* [Pilot und Produktionsreife](status/pilot-production-readiness.md)
* [Architektur-Baseline](status/bootstrap-materialization.md)
* [UNITERA — Managementübersicht](presentation/executive-overview.md)
