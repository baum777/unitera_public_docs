...
```mermaid
flowchart LR
    E["Evidenz und Quellen"] -->|"klassifizierter Kontext"| K["KNOW"]
    K -->|"minimierter Arbeitskontext"| T["THINK"]
    T -->|"Vorschlag"| A["Governance und ACT"]
    A -->|"kontrollierte Wirkung"| X["Externes System"]
    X -->|"Receipt und Verifikation"| E
```
