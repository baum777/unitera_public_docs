...
* [Personal Realm & Companion](product/personal-realm-companion.md)
...
* [Public contract index](contracts/README.md)
...
* [Build and integration entry](build/README.md)
* [Contributing](reference/contributing.md)

## Reference

* [Glossary](reference/glossary.md)
* [Pilot and production readiness](status/pilot-production-readiness.md)
* [Architecture baseline](status/bootstrap-materialization.md)
* [UNITERA — Executive Overview](presentation/executive-overview.md)
